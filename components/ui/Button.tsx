...
export const Button = ({
  ...
  const buttonClass = `p-5 font-medium text-xl lowercase border-2 border-solid rounded-full transition-all duration-200 ease-linear cursor-pointer active:scale-95 ${
