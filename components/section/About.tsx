...
export const About = () => {
  return (
    <section id="about" className="border-y-default">
      <PaddingOuter>
        <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-2.5">
          <div className="lg:w-1/2 lg:min-h-[600px] border-full-default rounded-lg">
            <PaddingInner>
              <SectionHeader
                icon={<FaUser />}
          ...
          <div className="lg:w-1/2 h-[600px] border-full-default rounded-lg">
            <Image
