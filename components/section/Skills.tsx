...
export const Skills = () => {
  return (
    <section id="skills" className="my-5 border-y-default">
      <PaddingOuter>
        <div className="w-full flex items-start justify-center flex-col border-y-default">
          <PaddingOuter>
            <SectionHeader
              icon={<FaReact />}
        ...
        <div className="mt-5 grid border-full-default rounded-lg">
          <PaddingOuter>
